...
const dockerImageList = [
    { name: 'Java 8', image: 'ghcr.io/kriegerhost/yolks:java_8' },
    { name: 'Java 11', image: 'ghcr.io/kriegerhost/yolks:java_11' },
    { name: 'Java 16', image: 'ghcr.io/kriegerhost/yolks:java_16' },
];

const JavaVersionModalFeature = () => {
    const [ visible, setVisible ] = useState(false);
    const [ loading, setLoading ] = useState(false);
    const [ selectedVersion, setSelectedVersion ] = useState('ghcr.io/kriegerhost/yolks:java_16');
