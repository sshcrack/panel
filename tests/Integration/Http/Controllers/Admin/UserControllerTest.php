...
namespace Kriegerhost\Tests\Integration\Http\Controllers\Admin;
...
use Kriegerhost\Http\Controllers\Admin\UserController;
...
class UserControllerTest extends IntegrationTestCase
{
     ...
     * are a subuser of.
     *
     * @see https://github.com/kriegerhost/panel/issues/2469
     */
    public function testIndexReturnsExpectedData()
    {
        ...
        /** @var \Kriegerhost\Http\Controllers\Admin\UserController $controller */
